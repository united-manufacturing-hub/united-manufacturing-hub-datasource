            ...
            data = options.targets.map(function (target, queryIndex) {
              ...
              if (query.labelsField !== undefined && query.labelsField !== '') {
                ...
                if (fieldNameIndex_1 === -1) {
                  ...
                  var newDatapoints_1 = _this.transpose(
                    datapoints[queryIndex].filter(function (element, eIndex) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [3 /*break*/, 1];
          case 4:
            return [2 /*return*/, { datapoints: datapoints, columnNames: columnNames }];
        }
      });
    });
  };
