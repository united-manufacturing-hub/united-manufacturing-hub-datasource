      ...
      if (_this.state.selectedValue.label === 'process_yourProcessValueName') {
        return React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'gf-form' },
            React.createElement(ProcessValue, {
              value: _this.state.uriPathExtension,
              onChange: _this.onuriPathExtensionChange,
            })
          )
        );
        ...
        return React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'gf-form' },
            React.createElement(AggregatedStates, {
